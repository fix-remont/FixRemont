...
// import { usePortfolioPostsStore } from '~/stores/portfolio_posts'
...
<template>
  <ClientOnly>
    <UCarousel class="margin-glob" v-if="items" :items="items" :ui="{
      ...
      <template #prev="{ onClick, disabled }">
        <img :class="[
          ...
          { 'opacity-60': disabled }
        ]" src="/images/arrow-prev.svg" @click="onClick" draggable="false" />
      </template>
      ...
      <template #next="{ onClick, disabled }">
        <img :class="[
          ...
          'h-[35px] w-[35px] sm:h-[60px] sm:w-[60px]',
          { 'opacity-60': disabled }
        ]" src="/images/arrow-next.svg" @click="onClick" draggable="false" />
      </template>
    </UCarousel>
  </ClientOnly>
</template>
