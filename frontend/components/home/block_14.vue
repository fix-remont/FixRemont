...
const items = [
	{ text: '1 Как рассчитать стоимость через онлайн- калькулятор FIX-ремонт?', img: '/images/home/block_14_for-blog.png' },
	{ text: '2 Как рассчитать стоимость через онлайн- калькулятор FIX-ремонт?', img: '/images/home/block_14_for-blog.png' },
	{ text: '3 Как рассчитать стоимость через онлайн- калькулятор FIX-ремонт?', img: '/images/home/block_14_for-blog.png' },
	{ text: '4 Как рассчитать стоимость через онлайн- калькулятор FIX-ремонт?', img: '/images/home/block_14_for-blog.png' },
	{ text: '5 Как рассчитать стоимость через онлайн- калькулятор FIX-ремонт?', img: '/images/home/block_14_for-blog.png' },
]
</script>

<template>
	<div class="block margin-glob">
		<h1 class="title-glob">Ведём блог, делимся <span class="orange"> многолетним опытом </span> и практической информацией</h1>
		<div class="box">
