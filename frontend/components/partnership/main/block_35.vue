<script setup>
const img = '/images/partnership/block_3.5.png'
...
<template>
  <div class="wrapper margin-glob">
    <div class="block_1">
      <div class="texts">
        <div class="title">Всего <span class="orange">4 шага и 10 мин</span> личного времени</div>
        <div class="text">отделяют вас от дома своей мечты</div>
      </div>
      <div class="tabs">
        <div
          v-for="(item, index) in itemsWithSelected"
        ...
        >
          ...
          <div
            :class="
              currentActiveIndex == index ? 'sm_block_2__selected' : 'sm_block_2__not_selected'
            "
          >
